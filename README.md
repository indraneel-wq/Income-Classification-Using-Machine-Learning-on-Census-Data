...
*   **Multi-Model Prediction**: Choose between Random Forest, XGBoost, and more.
...
1.  **Clone the Repository**
    ```bash
    git clone https://github.com/YOUR_USERNAME/census-income-predictor.git
...
The model is trained on the classic [Census Income Dataset](https://archive.ics.uci.edu/ml/datasets/census+income) (also known as the "Adult" dataset).
